...
import com.mycompany.task.config.audit.AuditEventConverter;
import com.mycompany.task.domain.PersistentAuditEvent;
...
import static com.mycompany.task.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
